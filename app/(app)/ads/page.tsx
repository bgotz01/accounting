...
import { getAdsData, type AdsSummary, type CampaignSummary, type DailySpend } from "./actions";
...
export default function AdsPage() {
    ...
    useEffect(() => {
        getAdsData().then(({ summary, campaigns, daily }) => {
            setSummary(summary);
    ...
    return (
        <div className="mx-auto max-w-5xl space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <MetricCard label="Total Spend" value={`$${summary.totalSpend.toLocaleString()}`} />
                <MetricCard label="Revenue" value={`$${summary.totalRevenue.toLocaleString()}`} />
                <MetricCard label="ROAS" value={`${summary.overallRoas}x`} highlight={summary.overallRoas >= 2} />
                <MetricCard label="CPA" value={`$${summary.cpa}`} />
            </div>
